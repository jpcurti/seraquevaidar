...
export class MainComponent implements OnInit {
  ...
  lengthRoll: number= 30;
  lengthSheet: number= 13;
  ...
  calculateDays(){
    let totalUsedSheetsPerDay = (this.sheetsPerUse * this.usesPerDay * this.numPeople * this.lengthSheet);
    let totalAvailableSheets = (this.rolls * this.lengthRoll * 100);
    ...
    switch(true) { 
      ...
      case (this.percentageSurviving<100): { 
        this.resultHashtagMessage= '#semdesperdicio #seraqueopapelvaidar'; 
         break; 
      } 
